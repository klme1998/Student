...
import com.excellent.model.Course_choose;
import com.excellent.model.Course_limit;
import com.excellent.model.Institution;
...
public interface CourseDao {
    ...
    public List<Course_choose> queryTeaIdByCourseId(int id);
