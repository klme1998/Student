...
<ul class="layui-nav layui-bg-blue">
    ...
    <li class="layui-nav-item ">
        ...
        <dl class="layui-nav-child">
            <dd><a href="<%=basePath%>student/courseList?page=1" style="font-size:16px;">课程信息</a></dd>
            <dd><a href="<%=basePath%>student/checkedCourseList" style="font-size:16px;">我的课程</a></dd>
        </dl>
    </li>
