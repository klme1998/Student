...
<rapid:override name="content">
    ...
    <form class="layui-form" id="changeform" method="post" action="<%=basePath%>teacher/changeTeaPass" style="margin:80px 400px; width:450px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input value="${teacher.teaName}" type="text" name="teaName" id="name" placeholder="请输入教师姓名" autocomplete="off" class="layui-input">
            </div>
                <label class="layui-form-label">教师密码</label>
                <div class="layui-input-block">
                <input value="${teacher.teaPass}" type="text" name="teaPass" id="pass" placeholder="请输入教师密码" autocomplete="off" class="layui-input">
                </div>
        </div>
    </form>
